...
const LinkPendente = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6">
      ...
      >
        <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-gold/10 border border-gold/20 mx-auto mb-6">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-8">
          Este link ainda está sendo preparado. Em breve estará disponível para você!
        </p>
      ...
      <div className="absolute bottom-8 flex flex-col items-center gap-2">
        <img src={logoImage} alt="Maria Marcelino" className="h-5 invert opacity-20" />
        <a
